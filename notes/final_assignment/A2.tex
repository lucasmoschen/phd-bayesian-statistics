...
% Title Page
\title{Exam 2 (A2)}
\author{Class: Bayesian Statistics \\ Student: Lucas Machado Moschen \\ Instructor: Luiz Max Carvalho}
\date{02/06/2021}
