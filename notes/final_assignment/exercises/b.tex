...
\fbox{\parbox{0.92\textwidth}{
    ...
    \begin{split}
        ...
        &= \left(\prod_{i=1}^n \binom{N}{x_i}\theta^{x_i}(1 - \theta)^{N-x_i}\right)\cdot \pi(\xi) \\
        &= \left(\prod_{i=1}^n \binom{N}{x_i}\right)\theta^{S}(1 - \theta)^{nN - S}\cdot \pi(\xi), 
    \end{split}
    \end{equation}
    ...
    \begin{enumerate}
        ...
        \begin{equation}
            ...
            p(\xi|\bx) \propto \left(\prod_{i=1}^n \binom{N}{x_i}\right)\frac{\Gamma(\alpha+N)\theta^{a+S-1-N}(1-\theta)^{b+nN-S-1}}{(\beta + 1/\theta)^{\alpha + N}N!}\one(0<\theta<1)
        \end{equation} 
    \end{enumerate}
}
}
...
\begin{enumerate}
    ...
    \begin{equation}
        ...
        \pi(\xi|\bx) \propto \left(\prod_{i=1}^n \binom{N}{x_i}\right) B(\alpha_1+1,N+\beta_1)\theta^{S + \alpha_2-1}(1-\theta)^{nN + \beta_2-S-1} \one(0<\theta<1) 
    \end{equation}
